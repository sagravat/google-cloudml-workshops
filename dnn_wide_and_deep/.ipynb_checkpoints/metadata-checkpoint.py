...
params = {
    ...
    #'TRANSFORMED_TRAIN_DATA_FILE_PREFIX': os.path.join(params.TRANSFORMED_DATA_DIR, 'carnival-train'),
    #'TRANSFORMED_EVAL_DATA_FILE_PREFIX': os.path.join(params.TRANSFORMED_DATA_DIR, 'carnival-eval'),
